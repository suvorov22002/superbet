...
public class Refreshd implements Runnable{
	...
	public static Refreshd  getInstance(){
		...
		Refreshd instance = new Refreshd( customers, display_draw );
		return instance;
	}
