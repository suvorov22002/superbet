...
async function buildPage1() {
    ...
    if (imagePage1 === ''){
        ...
        const image1 = 'ressources/lottery/assets/' + imagePage1 + '.jpg';
...
async function buildPage3() {
    ...
    str_combi = "";
    updateDrawNum2();
    const imag = 'ressources/lottery/assets/logo_' + coderace + '.jpeg';
...
function init(times) {
	...
	console.log('SCHEDULER INIT CODERACE '+coderace);
