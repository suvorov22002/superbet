...
public class DAOFactorys {
	...
	DAOFactorys( String url, String username, String password) {
		this.url = url;
	...
	*/
	...
	public static DAOFactorys getInstance() throws DAOConfigurationException {
		...
		DAOFactorys instance = new DAOFactorys( url, nomUtilisateur, motDePasse );
			return instance;
	}
